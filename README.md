...
The methods for adaptive exploration we developed are used in the context of PPO algorithms. A traditional objective of a PPO algorithm is the one introduced by OpenAI \cite{schulman2017proximal}, represented by the following loss function:
